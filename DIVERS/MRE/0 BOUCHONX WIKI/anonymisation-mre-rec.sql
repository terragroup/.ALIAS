...
delete from routerdcpimport_rdi where rdi_satut is null;
delete from routerdcpimport_rdi where rdi_satut <> 4;
delete from routerdcpimport_rdi where rdi_message = 'telechargement termine';
delete from routerdcpdelivery_rdd where rdd_rcd_id in (select rcd_id from routercontentdelivery_rcd where rcd_message not in ('Complet'));
delete from routerplaylistdelivery_rpd where rpd_rcd_id in (select rcd_id from routercontentdelivery_rcd where rcd_message not in ('Complet'));
delete from routercontentdelivery_rcd where rcd_message not in ('Complet');
