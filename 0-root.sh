...
echo "source 2-ssh"           && . "$AXL_HOME_ALIAS/ssh.sh"
echo "source 3-git"           && . "$AXL_HOME_ALIAS/git.sh"
echo "source 4-mvn"           && . "$AXL_HOME_ALIAS/mvn.sh"
echo "source 5-search"        && . "$AXL_HOME_ALIAS/search.sh"
echo "source 6-pgsql"         && . "$AXL_HOME_ALIAS/pgsql.sh"
echo "source 7-log"           && . "$AXL_HOME_ALIAS/log.sh"
echo "source 8-server"        && . "$AXL_HOME_ALIAS/server.sh"
echo "source 9-network"       && . "$AXL_HOME_ALIAS/network.sh"

echo "source 10-mac"           && . "$AXL_HOME_ALIAS/mac.sh"
